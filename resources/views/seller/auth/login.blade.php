...
<head>
        ...
        <title>Anzam Shop | Seller Login</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern shadow-none">
                            <div class="card-body">
                                ...
                                <div class="p-3"> 
                                    ...
                                    <p class="text-muted text-center mb-4">Sign in to continue as Seller.</p>
                                    <div id="message_area" style="display: none"></div>
                                    <form  class="form-horizontal" data-action="{{ route('seller.login') }}" method="POST" id="kt_sign_in_form">
                						@csrf
                        ...
                        <div class="mt-5 text-center text-white-50">
                            <p>Don't have an account ? <a href="{{ route('seller.register') }}" class="font-500 text-white"> Create Seller Account </a> </p>
