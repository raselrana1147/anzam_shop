...
@section("seller_title","Seller | Update Profile")
       ...
       <div class="col-lg-8 offset-2">
           <div class="card">
               <div class="card-body">
                  ...
                  <form id="submit_form" class="custom-validation" data-action="{{ route('seller.change_profile') }}"  method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row pb-4">
                     <div class="offset-4">
