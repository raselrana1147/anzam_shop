                ...
                <div class="topbar-left">
                    <a href="{{ route('seller.dashboard') }}" class="logo">
                        <span class="logo-light">
                            <img src="{{ asset('assets/backend/image/logo.png') }}" alt="" height="22">
                        </span>
                        <span class="logo-sm">
                            <img src="{{ asset('assets/backend/image/logo.png') }}" alt="" height="22">
                        </span>
                        ...
                        <li class="dropdown notification-list list-inline-item">
                                    <div class="dropdown notification-list nav-pro-img">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                            <!-- item-->
                                            <a class="dropdown-item" href="{{ route('seller.profile_form') }}"><i class="mdi mdi-account-circle"></i>Update Profile</a>
                                            <a class="dropdown-item" href="{{ route('seller.password_form') }}"><i class="mdi mdi-lock"></i>Change Password</a>
