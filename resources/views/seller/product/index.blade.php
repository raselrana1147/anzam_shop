...
@section("seller_title","Seller | Product List")
...
@section("seller_content")
   <div class="row">
       <div class="col-12">
           <div class="card">
               <div class="card-body">
                     <a href="{{ route('seller.product_create') }}" class="btn btn-primary btn-icon float-right"><span class="btn-icon-label"><i class="fas fa-plus mr-2"></i></span>Add New</a>
                     ...
                     <div class="col-lg-12">
                         <div class="card">
                             <div class="card-body">
                                 ...
                                 <form id="set_flash_deal" data-action="{{ route('seller.set_flash_deal') }}" method="POST">
                                  @csrf
