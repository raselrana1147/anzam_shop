	                    ...
	                    <div class="col-md-9 welcome-about-us">
	                        ...
	                        <div class="content-about-us">
	                            <div class="image-about-us">
	                                <img src="{{ asset('assets/frontend/assets/image/catalog/about/about-us.jpg') }}" alt="Image Client">
	                            </div>
	                                                ...
	                                                <div class="w-image-box">
	                                                    <div class="item-image">
	                                                        <a title="Jennifer lawrence" href="#">
	                                                            <img src="{{ asset('assets/frontend/assets/image/catalog/about/cl-image-1.jpg')}}" alt="Image Client">
	                                                        </a>
	                                                    </div>
	                                                </div>
	                                        ...
	                                        <div class="item respl-item">
	                                            <div class="item-inner">
	                                                <div class="w-image-box">
	                                                    <div class="item-image">
	                                                        <a title="Jennifer lawrence" href="#">
	                                                            <img src="{{ asset('assets/frontend/assets/image/catalog/about/cl-image-2.jpg')}}" alt="Image Client">
	                                                        </a>
	                                                    </div>
	                                                </div>
	                                                <div class="info-member">
	                                        ...
	                                        <div class="item respl-item">
	                                            <div class="item-inner">
	                                                <div class="w-image-box">
	                                                    <div class="item-image">
	                                                        <a title="Jennifer lawrence" href="#">
	                                                            <img src="{{ asset('assets/frontend/assets/image/catalog/about/cl-image-3.jpg')}}" alt="Image Client">
	                                                        </a>
	                                                    </div>
	                                                </div>
	                                                <div class="info-member">
	                                        ...
	                                        <div class="item respl-item">
	                                            <div class="item-inner">
	                                                <div class="w-image-box">
	                                                    <div class="item-image">
	                                                        <a title="Jennifer lawrence" href="#">
	                                                            <img src="{{ asset('assets/frontend/assets/image/catalog/about/cl-image-4.jpg')}}" alt="Image Client">
	                                                        </a>
	                                                    </div>
	                                                </div>
	                                                <div class="info-member">
