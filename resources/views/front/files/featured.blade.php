  <div id="so_category_slider_1" class="so-category-slider container-slider module cateslider1">
                    <div class="modcontent">                                                                
                        <div class="page-top">
                            <div class="page-title-categoryslider">Featured Products</div>
                        ...
                        <div class="categoryslider-content">
                            <div class="item-cat-image" style="min-height: 351px;">
                                <a href="#" title="Fashion & Accessories" target="_self">
                                  <img class="categories-loadimage" alt="Fashion & Accessories" src="{{ asset('assets/frontend/assets/image/catalog/demo/category/tab3.jpg')}}">
                                </a>
                            </div>
                                            ...
                                            <div class="product-item-container">
                                                <div class="left-block left-b">
                                                    ...
                                                    <div class="product-image-container second_img">
                                                        <a href="{{ route('product.detail',$featured->slug) }}" target="_self" title="Lastrami bacon">
                                                            <img src="{{ asset('assets/backend/image/product/small/'.$featured->thumbnail)}}" class="img-1 img-responsive" alt="image1">
                                                            <img src="{{ count($featured->galleries)>0 ? asset('assets/backend/image/gallery/small/'.$featured->galleries['0']['image']) : asset('assets/backend/image/product/small/'.$featured->thumbnail)}}" class="img-2 img-responsive" alt="image2">
                                                        </a>
                                                    </div>
                                                    <!--quickview--> 
                                                ...
                                                <div class="right-block">
                                                    ...
                                                    <div class="caption hide-cont">
                                                        ...
                                                        <h4><a href="{{ route('product.detail',$featured->slug) }}" title="Pastrami bacon" target="_self">{{$featured->name}}</a></h4>
                                                        
                                                    </div>
                                                    <p class="price">
                                                      <span class="price-new">{{price_format($featured->current_price)}}</span>
