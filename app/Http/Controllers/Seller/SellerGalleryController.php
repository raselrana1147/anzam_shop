...
class SellerGalleryController extends Controller
{
     ...
     public function index($id)
     {
     	...
     	return view('seller.gallery.index',compact('galleries','product'));
     }

     public function edit($id)
     {
        $gallery=Gallery::findOrFail($id);
        return view('seller.gallery.edit',compact("gallery"));
     }
       ...
       if ($request->isMethod('post'))
         {
             ...
             try{
                 ...
                 if($request->hasFile('image')){
                         ...
                         Image::make($image)->resize(700,700)->save($small_image_path);
